...
import { CardBody, CardText, CardTitle, Container, Col, Card, Row, CardImg, CardSubtitle } from 'reactstrap';
...
function ProfileCard(props) {
    return(
        <Col style={{flex: 1}}>
            <Card>
                <CardImg top width="100%" src={"../../public/images/profile_pics/" + props.profile.profile_img} alt={props.profile.name + " profile picture"}/>
                <CardBody>
